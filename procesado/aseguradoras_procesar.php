...
<body>
    <nav>
        <ul>
            ...
            <li><a class=activo href=../Ventanas/aseguradoras.php>Aseguradoras</a></li>
...
if (isset($_REQUEST["ingresar"])) {
    try {
        $insert  = "INSERT INTO artículos(`Nombre`, `NIF`, `Dirección`, `Código Postal`, `Población`, `Teléfono`, `Web`, `Correo`, `Otra información`) VALUES
            ('".$_REQUEST['nombre']."',
            '".$_REQUEST['nif']."',
            '".$_REQUEST['direccion']."',
            '".$_REQUEST['cp']."',
